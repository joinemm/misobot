...
class ImageObject:
    ...
    def write_box(self, x, y, width, height, color, text):
        ...
        while True:
            ...
            for w, word in enumerate(words):
                if '\n' in word:
                    ...
                    size = self.get_text_size(self.font, font_size, new_line)
                    line_height = size[1]
                    if size[0] <= width:
                ...
                size = self.get_text_size(self.font, font_size, ' '.join(line))
        ...
        for i, line in enumerate(lines):
            total_size = self.get_text_size(self.font, font_size, line)
