...
class Database:
    ...
    def __init__(self):
        self.datafiles = {"data": Datafile('data/data.json'),
                          "guilds": Datafile('data/guilds.json'),
                          "index": Datafile('data/index.json'),
                          "notifications": Datafile('data/notifications.json'),
                          "users": Datafile('data/users.json')}
